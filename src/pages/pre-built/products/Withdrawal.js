...
import { allWithdrawal, createWithdrawal } from "../../../redux/withdrawalSlice/withdrawalApi";
...
const Withdrawal = () => {
  ...
  const {
    getAllWithdrawal: { getWithdrawalData, getWithdrawalLoading, getWithdrawalError },
  ...
  // useEffect(() => {
  //   const total = depositData.reduce((acc, row) => acc + parseFloat(row.amount), 0);
  //   setFormData((prev) => {
  //     return {
  //       ...prev,
  //       balance: total,
  ...
  const onFormSubmit = () => {
    // console.log(formData, "submit2");
    createWithdrawal(formData, dispatch);
  };
  ...
  const currentItems = withdrawalData?.slice(indexOfFirstItem, indexOfLastItem);
    ...
    <React.Fragment>
      ...
      <Content>
                          ...
                          <DataTableItem key={item.id}>
                            ...
                            <DataTableRow size="sm">
                              <span className="tb-product">
                                ...
                                <span className="title">{item?.method}</span>
                              </span>
                            </DataTableRow>
                            <DataTableRow>
                            ...
                            <DataTableRow>
                              <span className="tb-sub">
                                {moment(new Date(item?.timeStamp?.seconds * 1000)).format("MMMM Do YYYY")}
                              </span>
                            </DataTableRow>
                            {/* <DataTableRow size="md">
                              <span className="tb-sub">
        ...
        >
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Withdrawal Transaction</BlockTitle>
            </BlockHeadContent>
          </BlockHead>
          <Block>
            <form onSubmit={handleSubmit(onFormSubmit)}>
              <Row className="g-3">
                <Col md="12">
                  <label className="form-label">Select your method</label>
                  <div className="form-control-wrap">
                    <RSelect
                      options={methods}
                ...
                <Col size="12">
                  <Button
                    ...
                    // onClick={() => {
                    //   getWithdrawalData && onFormCancel()
                    // }}
                  >
                    <Icon className="plus"></Icon>
                    <span>Submit</span>
                    {/* <span>{getWithdrawalLoading ? "Loading..." : "Submit"}</span> */}
                  </Button>
                </Col>
              </Row>
            </form>
