...
//!deposit
import Deposit from "../pages/pre-built/products/Deposit"
...
import Withdrawal from "../pages/pre-built/products/Withdrawal";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/deposit`} component={Deposit}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/withdrawal`} component={Withdrawal}></Route>
